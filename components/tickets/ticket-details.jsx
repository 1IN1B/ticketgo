    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="space-y-6">
        {isAdmin && (
          ...
          >
            <Card className="shadow-sm border-amber-200/50 bg-amber-50/5 dark:bg-amber-950/10">
              <CardHeader className="pb-3 border-b border-amber-100/50 mb-4 bg-amber-50/30 dark:bg-amber-950/20">
